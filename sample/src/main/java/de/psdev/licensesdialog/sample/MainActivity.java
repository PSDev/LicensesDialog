...
public class MainActivity extends AppCompatActivity {
    ...
    public void onSingleClick(final View view) {
        ...
        final String url = "https://github.psdev.de/";
        final String copyright = "Copyright 2013-2018 Philip Schiffer <admin@psdev.de>";
    ...
    public void onMultipleProgrammaticClick(final View view) {
        ...
        notices.addNotice(new Notice("Test 1", "https://example.org/", "Example Person", new ApacheSoftwareLicense20()));
        notices.addNotice(new Notice("Test 2", "https://example.org/", "Example Person 2", new GnuLesserGeneralPublicLicense21()));
    ...
    public void onMultipleProgrammaticFragmentClick(final View view) {
        ...
        notices.addNotice(new Notice(
                "Test 1", "https://example.org/", "Example Person", new ApacheSoftwareLicense20()));
        notices.addNotice(new Notice(
                "Test 2", "https://example.org/", "Example Person 2", new GnuLesserGeneralPublicLicense21()));
    ...
    public void onCustomCssStyleFragmentClick(final View view) {
